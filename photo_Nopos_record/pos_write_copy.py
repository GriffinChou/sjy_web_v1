            ...
            try:
                ...
                try:
                    ...
                    for data_j in b[uuu][0:3]:
                        open(file_name, 'a+').write(data_j + '\t')
                    open(file_name, 'a+').write('\n')
                # elif nnn<= uuu and uuu<2*nnn:
                #     b[uuu][0] = path_floder[1].split('\\')[-1]+'_' + '%010d' % int(name_i)
                #     try:
                #         for data_j in b[uuu][0:7]:
                #             open(file_name, 'a+').write(data_j + '\t')
                #         open(file_name, 'a+').write('\n')
                ...
                #             open(file_name, 'a+').write(data_j + '\t')
                #         open(file_name, 'a+').write('\n')
                # elif 2*nnn<= uuu and uuu<3*nnn:
                #     b[uuu][0] = path_floder[2].split('\\')[-1]+'_' + '%010d' % int(name_i)
                #     try:
                #         for data_j in b[uuu][0:7]:
                #             open(file_name, 'a+').write(data_j + '\t')
                #         open(file_name, 'a+').write('\n')
                ...
                #             open(file_name, 'a+').write(data_j + '\t')
                #         open(file_name, 'a+').write('\n')
                # elif 3*nnn<= uuu and uuu<4*nnn:
                #     b[uuu][0] = path_floder[3].split('\\')[-1]+'_' + '%010d' % int(name_i)
                #     try:
                #         for data_j in b[uuu][0:7]:
                #             open(file_name, 'a+').write(data_j + '\t')
                #         open(file_name, 'a+').write('\n')
                ...
                #             open(file_name, 'a+').write(data_j + '\t')
                #         open(file_name, 'a+').write('\n')
                # elif 4*nnn<= uuu and uuu<5*nnn:
                #     b[uuu][0] = path_floder[4].split('\\')[-1]+'_' + '%010d' % int(name_i)
                #     try:
                #         for data_j in b[uuu][0:7]:
                #             open(file_name, 'a+').write(data_j + '\t')
                #         open(file_name, 'a+').write('\n')
