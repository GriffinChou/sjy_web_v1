...
class Option(
    Onidc,
    # Parent,
    Mark, PersonTime, ActiveDelete, Remark
):
...
#必须有
    ...
    style = models.ForeignKey(
        ...
        verbose_name="客户类型", help_text="从客户类型选项中选取")
...
class Pdu(
    ...
    class Meta(Mark.Meta):
        ...
        default_permissions = ('view', 'add', 'change', 'delete', 'exports')
        unique_together = (('rack', 'name'),)
        verbose_name = verbose_name_plural = "性能监控"
...
class Device(Onidc, Mark, PersonTime, ActiveDelete, Remark):
    ...
    # #保存上传的文件
    # FileField.save(name, ipaddr, save=True)
...
class Offline(Device):
    ...
    class Meta(Mark.Meta):
        ...
        default_permissions = ('view', 'add', 'change', 'delete', 'exports')
        proxy = True
        verbose_name = verbose_name_plural = "工程管理11111"
...
class Jumpline(Onidc, Mark, PersonTime, ActiveDelete, Remark):
    ...
    sclient = models.ForeignKey(
        'Client',
        on_delete=models.PROTECT,
        verbose_name="所属客户", help_text="选择本端客户"
    )
    ...
    sflag = models.CharField(
        max_length=64, verbose_name="项目名称",
        help_text="填写项目名称，例如：长新村项目"
    )
    ...
    class Meta(Mark.Meta):
        ...
        default_permissions = ('view', 'add', 'change', 'delete', 'exports')
        ordering = ['-actived', '-modified']
        verbose_name = verbose_name_plural = "项目状态"
...
class Zonemap(Onidc, Mark, PersonTime, ActiveDelete, Remark):
    ...
    class Meta(Mark.Meta):
        ...
        verbose_name = verbose_name_plural = "模型管理"
...
class Goods(Onidc, Mark, PersonTime, ActiveDelete):
    ...
    name = models.CharField(
        max_length=100, verbose_name="工程名称",
        help_text="推荐命名规则:客户-项目-工程"
    )
    ...
    class Meta(Mark.Meta):
        ...
        list_display = ['name', 'unit', 'brand',
                        # 'actived', 'mark'
                        ]
        default_permissions = ('view', 'add', 'change', 'delete', 'exports')
        # ordering = ['-modified']
        unique_together = (('brand', 'name'),)
        verbose_name = verbose_name_plural = "工程管理"
...
class Inventory(
    ...
    goods = models.ForeignKey(
        ...
        verbose_name="工程名称", help_text="从现有工程中选取")
    ...
    expressnum = models.CharField(
        ...
        # blank=True, null=True,
        verbose_name="POS名称",
        help_text="例如：超图五镜头POS数据"
    )
    #数量需要做统计
    amount = models.IntegerField(
        verbose_name="数量",
        help_text="统计上传的pos文件数量"
    )
    amount = models.IntegerField(
        verbose_name="数量",
        help_text="统计上传的pos文件数量"
    ...
    class Meta(Mark.Meta):
        ...
        ordering = ['-actived', '-modified']
        verbose_name = verbose_name_plural = "POS处理"


#照片元数据提取
@python_2_unicode_compatible
class Testapply(Onidc, Mark, PersonTime, ActiveDelete, Intervaltime, Remark,ClientAble,Parent):

    name = models.CharField(
        max_length=32, unique=True, verbose_name="元数据名称",
        help_text="新建照片元数据名称")
    ...
    #     max_length=32, verbose_name="所属工程",
    #     help_text="填写所属项目，如：超图")
    ...
    location = models.FileField(
        ...
        # default="avatar/default.png",
        blank=True,
        default="avatar/2021/01/21/test.txt",
        verbose_name="元数据地址",
        help_text="存放位置, 从本地选取")
    ...
    class Meta(Mark.Meta):
        ...
        dashboard = True
        list_display = [
            'name',  'client', 'goods','location',
            'start_time',
            'end_time',
            # 'device','system_ip', 'system_user','expired', 'proposer', 'actived',
        ]
        # extra_fields = ['expired']
        default_permissions = ('view', 'add', 'change', 'delete', 'exports')
        # ordering = ['-actived', '-modified']
        verbose_name = verbose_name_plural = "照片元数据处理"
...
class Document(Onidc, Mark, PersonTime, ActiveDelete, Remark):
    ...
    class Meta(Mark.Meta):
        ...
        list_display = [
            ...
            'tags']
        default_permissions = ('view', 'add', 'change', 'delete', 'exports')
        verbose_name = verbose_name_plural = "数据修改"
